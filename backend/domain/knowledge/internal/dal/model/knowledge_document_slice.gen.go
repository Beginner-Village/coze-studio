...
type KnowledgeDocumentSlice struct {
	...
	Content     string         `gorm:"column:content;comment:content" json:"content"`                                           // content (Q for QA format)
	Answer      string         `gorm:"column:answer;comment:answer content for QA format" json:"answer"`                        // answer content for QA format
