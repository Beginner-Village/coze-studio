...
import (
	...
	"github.com/ynet-dev/ynet-studio/backend/domain/statistics/internal/dal/model"
)
...
func newMessage(db *gorm.DB, opts ...gen.DOOption) message {
	...
	_message.Ext = field.NewField(tableName, "ext")
...
func (m *message) updateTableName(table string) *message {
	...
	m.Ext = field.NewField(table, "ext")
