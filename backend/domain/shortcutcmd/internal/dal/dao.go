...
import (
	...
	"github.com/ynet-dev/ynet-studio/backend/domain/shortcutcmd/internal/dal/model"
	"github.com/ynet-dev/ynet-studio/backend/domain/shortcutcmd/internal/dal/query"
