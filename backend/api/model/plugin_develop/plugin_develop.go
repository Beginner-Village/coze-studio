...
func (p *CreateFolderRequest) GetSpaceID() int64 {
	if p != nil {
		return p.SpaceID
	}
	return 0
...
type MoveResourcesToFolderRequest struct {
	SpaceID         int64    `form:"space_id" json:"space_id,string"`
	FolderID        int64    `form:"folder_id" json:"folder_id,string"`
	ResourceIDStrs  []string `form:"resource_ids" json:"resource_ids"`
	ResourceType    int32    `form:"resource_type" json:"resource_type"` // 2=workflow
	Base            *base.Base `form:"Base" json:"Base,omitempty" query:"Base"`
}

func (p *MoveResourcesToFolderRequest) GetSpaceID() int64 {
	if p != nil {
		return p.SpaceID
	}
	return 0
...
func (p *MoveResourcesToFolderRequest) GetFolderID() int64 {
	if p != nil {
		return p.FolderID
	}
	return 0
...
type MoveResourcesToFolderResponse struct {
	Code int32  `json:"code"`
	Msg  string `json:"msg"`
}
