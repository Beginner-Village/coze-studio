...
type ExtraInfo struct {
	...
	YnetType string `thrift:"ynet_type,23" form:"ynet_type" json:"ynet_type" query:"ynet_type"`
	// unique card identifier
	CardID string `thrift:"card_id,24" form:"card_id" json:"card_id" query:"card_id"`
	// card template identifier
	TemplateID string `thrift:"template_id,25" form:"template_id" json:"template_id" query:"template_id"`
	// card template name
	TemplateName string `thrift:"template_name,26" form:"template_name" json:"template_name" query:"template_name"`
	// current card field being updated (for card_delta)
	CardField string `thrift:"card_field,27" form:"card_field" json:"card_field" query:"card_field"`
	// card_delta specific fields
	// card field value (for card_delta, moved from content/answer)
	CardValue string `thrift:"card_value,28" form:"card_value" json:"card_value" query:"card_value"`
	// operation type for card_delta: "add" for array elements, "set" for simple values
	CardOp string `thrift:"card_op,29" form:"card_op" json:"card_op" query:"card_op"`
	// Card group metadata fields
	GroupID string `thrift:"group_id,30" form:"group_id" json:"group_id" query:"group_id"`
	// layout type: horizontal, vertical, waterfall (for card_group_start)
	CardLayout string `thrift:"card_layout,31" form:"card_layout" json:"card_layout" query:"card_layout"`
	// number of columns as string (for card_group_start)
	CardColumns string `thrift:"card_columns,32" form:"card_columns" json:"card_columns" query:"card_columns"`
}
...
func (p *ExtraInfo) GetYnetType() (v string) {
	return p.YnetType
}

func (p *ExtraInfo) GetCardID() (v string) {
	return p.CardID
}

func (p *ExtraInfo) GetTemplateID() (v string) {
	return p.TemplateID
}

func (p *ExtraInfo) GetTemplateName() (v string) {
	return p.TemplateName
}

func (p *ExtraInfo) GetCardField() (v string) {
	return p.CardField
}

func (p *ExtraInfo) GetGroupID() (v string) {
	return p.GroupID
}

func (p *ExtraInfo) GetCardLayout() (v string) {
	return p.CardLayout
}

func (p *ExtraInfo) GetCardColumns() (v string) {
	return p.CardColumns
}
...
func (p *ExtraInfo) ReadField23(iprot thrift.TProtocol) error {
...
func (p *ExtraInfo) ReadField24(iprot thrift.TProtocol) error {
...
func (p *ExtraInfo) ReadField25(iprot thrift.TProtocol) error {
...
func (p *ExtraInfo) ReadField26(iprot thrift.TProtocol) error {
...
func (p *ExtraInfo) ReadField27(iprot thrift.TProtocol) error {
...
func (p *ExtraInfo) ReadField28(iprot thrift.TProtocol) error {
...
func (p *ExtraInfo) ReadField29(iprot thrift.TProtocol) error {
...
func (p *ExtraInfo) ReadField30(iprot thrift.TProtocol) error {
...
func (p *ExtraInfo) writeField23(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("ynet_type", thrift.STRING, 23); err != nil {
		goto WriteFieldBeginError
	}
	if err := oprot.WriteString(p.YnetType); err != nil {
		return err
	}
	if err = oprot.WriteFieldEnd(); err != nil {
		goto WriteFieldEndError
...
func (p *ExtraInfo) writeField24(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("card_id", thrift.STRING, 24); err != nil {
		goto WriteFieldBeginError
	}
...
func (p *ExtraInfo) writeField25(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("template_id", thrift.STRING, 25); err != nil {
		goto WriteFieldBeginError
	}
...
func (p *ExtraInfo) writeField26(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("template_name", thrift.STRING, 26); err != nil {
		goto WriteFieldBeginError
	}
...
func (p *ExtraInfo) writeField27(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("card_field", thrift.STRING, 27); err != nil {
		goto WriteFieldBeginError
	}
	if err := oprot.WriteString(p.CardField); err != nil {
		return err
	}
	if err = oprot.WriteFieldEnd(); err != nil {
		goto WriteFieldEndError
...
func (p *ExtraInfo) writeField28(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("group_id", thrift.STRING, 28); err != nil {
		goto WriteFieldBeginError
	}
...
func (p *ExtraInfo) writeField29(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("card_layout", thrift.STRING, 29); err != nil {
		goto WriteFieldBeginError
	}
	if err := oprot.WriteString(p.CardLayout); err != nil {
		return err
	}
	if err = oprot.WriteFieldEnd(); err != nil {
		goto WriteFieldEndError
...
func (p *ExtraInfo) writeField30(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("card_columns", thrift.STRING, 30); err != nil {
		goto WriteFieldBeginError
	}
	if err := oprot.WriteString(p.CardColumns); err != nil {
		return err
	}
	if err = oprot.WriteFieldEnd(); err != nil {
		goto WriteFieldEndError
