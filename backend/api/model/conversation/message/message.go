...
type ExtraInfo struct {
	...
	GroupID string `thrift:"group_id,28" form:"group_id" json:"group_id" query:"group_id"`
	// layout type: horizontal, vertical, waterfall (for card_group_start)
	CardLayout string `thrift:"card_layout,29" form:"card_layout" json:"card_layout" query:"card_layout"`
	// number of columns as string (for card_group_start)
	CardColumns string `thrift:"card_columns,30" form:"card_columns" json:"card_columns" query:"card_columns"`
}
