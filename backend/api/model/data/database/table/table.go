...
type DatabaseInfo struct {
	...
	// Whether the current user can edit this database
	CanEdit *bool `thrift:"can_edit,22,optional" form:"can_edit" json:"can_edit,omitempty" query:"can_edit"`
}
...
var DatabaseInfo_CanEdit_DEFAULT bool

func (p *DatabaseInfo) GetCanEdit() (v bool) {
	if !p.IsSetCanEdit() {
		return DatabaseInfo_CanEdit_DEFAULT
	}
	return *p.CanEdit
}
...
func (p *DatabaseInfo) IsSetCanEdit() bool {
...
func (p *DatabaseInfo) ReadField22(iprot thrift.TProtocol) error {
...
func (p *DatabaseInfo) writeField22(oprot thrift.TProtocol) (err error) {
	if p.IsSetCanEdit() {
		if err = oprot.WriteFieldBegin("can_edit", thrift.BOOL, 22); err != nil {
			goto WriteFieldBeginError
		}
