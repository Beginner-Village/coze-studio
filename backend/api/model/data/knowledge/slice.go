...
type SliceInfo struct {
	// Sharding ID
	SliceID int64 `thrift:"slice_id,1" form:"slice_id" json:"slice_id,string" query:"slice_id"`
	// Sharding content (Q for QA format)
	...
	Answer *string `thrift:"answer,6,optional" form:"answer" json:"answer,omitempty" query:"answer"`
	// serial number
...
var SliceInfo_Answer_DEFAULT string

func (p *SliceInfo) GetAnswer() (v string) {
	if !p.IsSetAnswer() {
		return SliceInfo_Answer_DEFAULT
	}
	return *p.Answer
}
...
func (p *SliceInfo) IsSetAnswer() bool {
	return p.Answer != nil
}
