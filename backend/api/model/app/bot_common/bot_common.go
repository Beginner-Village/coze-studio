...
type MemoryToolMode int64

const (
	// Disabled - no memory tools
	MemoryToolMode_Disabled MemoryToolMode = 0
	// Enabled - add memory tools automatically
	MemoryToolMode_Enabled MemoryToolMode = 1
)

func (p MemoryToolMode) String() string {
	switch p {
	case MemoryToolMode_Disabled:
		return "Disabled"
	case MemoryToolMode_Enabled:
		return "Enabled"
	}
	return "<UNSET>"
}

func MemoryToolModeFromString(s string) (MemoryToolMode, error) {
	switch s {
	case "Disabled":
		return MemoryToolMode_Disabled, nil
	case "Enabled":
		return MemoryToolMode_Enabled, nil
	}
	return MemoryToolMode(0), fmt.Errorf("not a valid MemoryToolMode string")
}

func MemoryToolModePtr(v MemoryToolMode) *MemoryToolMode { return &v }
func (p *MemoryToolMode) Scan(value interface{}) (err error) {
	var result sql.NullInt64
	err = result.Scan(value)
	*p = MemoryToolMode(result.Int64)
	return
}

func (p *MemoryToolMode) Value() (driver.Value, error) {
	if p == nil {
		return nil, nil
	}
	return int64(*p), nil
...
type ModelInfo struct {
	...
	ResponseFormat *ModelResponseFormat `thrift:"ResponseFormat,9,optional,ModelResponseFormat" form:"response_format" json:"response_format,omitempty"`
	// User-selected model style
	ModelStyle *ModelStyle `thrift:"ModelStyle,10,optional,ModelStyle" form:"model_style" json:"model_style,omitempty"`
}
...
type ShortMemoryPolicy struct {
	// The type of transmission allowed by the context
	ContextMode *ContextMode `thrift:"ContextMode,1,optional,ContextMode" form:"context_mode" json:"context_mode,omitempty"`
...
type WorkflowInfo struct {
	...
	FlowMode *WorkflowMode `thrift:"FlowMode,4,optional,WorkflowMode" form:"flow_mode" json:"flow_mode,omitempty"`
	// workflow name
	...
	Parameters   []*PluginParameter `thrift:"Parameters,7,optional,list<PluginParameter>" form:"parameters" form:"parameters" json:"parameters,omitempty"`
...
type PluginParameter struct {
	...
	SubParameters []*PluginParameter `thrift:"SubParameters,5,optional,list<PluginParameter>" form:"sub_parameters" json:"sub_parameters,omitempty"`
...
type OnboardingInfo struct {
	...
	// suggestion question
	SuggestedQuestions []string `thrift:"SuggestedQuestions,2,optional,list<string>" form:"suggested_questions" json:"suggested_questions,omitempty"`
	// Opener model
	OnboardingMode *OnboardingMode `thrift:"OnboardingMode,3,optional,OnboardingMode" form:"onboarding_mode" json:"onboarding_mode,omitempty"`
	...
	SuggestedQuestionsShowMode *SuggestedQuestionsShowMode `thrift:"SuggestedQuestionsShowMode,5,optional,SuggestedQuestionsShowMode" form:"suggested_questions_show_mode" json:"suggested_questions_show_mode,omitempty"`
}
...
type SuggestReplyInfo struct {
	...
	SuggestReplyMode *SuggestReplyMode `thrift:"SuggestReplyMode,1,optional,SuggestReplyMode" form:"suggest_reply_mode" json:"suggest_reply_mode,omitempty"`
...
type VoicesInfo struct {
	...
	DefaultUserInputType *DefaultUserInputType `thrift:"DefaultUserInputType,6,optional,DefaultUserInputType" form:"default_user_input_type" json:"default_user_input_type,omitempty"`
}
...
type AnswerActionTriggerRule struct {
	Type           AnswerActionTriggerType `thrift:"Type,1,default,AnswerActionTriggerType" form:"type" json:"type"`
...
type AnswerActions struct {
	AnswerActionsMode   AnswerActionsMode     `thrift:"AnswerActionsMode,1,default,AnswerActionsMode" form:"answer_actions_mode" json:"answer_actions_mode"`
	AnswerActionConfigs []*AnswerActionConfig `thrift:"AnswerActionConfigs,2,default,list<AnswerActionConfig>" form:"answer_action_configs" json:"answer_action_configs"`
}
...
type BotExtInfo struct {
	...
	CardIds         []int32        `thrift:"CardIds,2,optional,list<i32>" form:"card_ids" json:"card_ids,omitempty"`
...
type Knowledge struct {
	...
	KnowledgeInfo []*KnowledgeInfo `thrift:"KnowledgeInfo,1,optional,list<KnowledgeInfo>" form:"knowledge_info" json:"knowledge_info,omitempty"`
	...
	// search strategy
	SearchStrategy *SearchStrategy `thrift:"SearchStrategy,5,optional,SearchStrategy" form:"search_strategy" json:"search_strategy,omitempty"`
	...
	NoRecallReplyMode *KnowledgeNoRecallReplyMode `thrift:"NoRecallReplyMode,7,optional,KnowledgeNoRecallReplyMode" form:"no_recall_reply_mode" json:"no_recall_reply_mode,omitempty"`
	...
	ShowSourceMode *KnowledgeShowSourceMode `thrift:"ShowSourceMode,9,optional,KnowledgeShowSourceMode" form:"show_source_mode" json:"show_source_mode,omitempty"`
...
type SocietyVisibiltyConfig struct {
	...
	VisibilityType SocietyVisibility `thrift:"VisibilityType,1,default,SocietyVisibility" json:"visibility_type,omitempty" form:"visibility_type" `
	// list of visible characters
	VisibilityRoles []string `thrift:"VisibilityRoles,2,default,list<string>" json:"visibility_roles,omitempty" form:"visibility_roles" `
}
...
type MemoryToolConfig struct {
	// Memory tool mode, default is Enabled for backward compatibility
	Mode *MemoryToolMode `thrift:"Mode,1,optional,MemoryToolMode" form:"mode" json:"mode,omitempty"`
}

func NewMemoryToolConfig() *MemoryToolConfig {
	return &MemoryToolConfig{}
}

func (p *MemoryToolConfig) InitDefault() {
}

var MemoryToolConfig_Mode_DEFAULT MemoryToolMode

func (p *MemoryToolConfig) GetMode() (v MemoryToolMode) {
	if !p.IsSetMode() {
		return MemoryToolConfig_Mode_DEFAULT
	}
	return *p.Mode
}

var fieldIDToName_MemoryToolConfig = map[int16]string{
	1: "Mode",
}

func (p *MemoryToolConfig) IsSetMode() bool {
	return p.Mode != nil
}

func (p *MemoryToolConfig) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_MemoryToolConfig[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *MemoryToolConfig) ReadField1(iprot thrift.TProtocol) error {

	var _field *MemoryToolMode
	if v, err := iprot.ReadI32(); err != nil {
		return err
	} else {
		tmp := MemoryToolMode(v)
		_field = &tmp
	}
	p.Mode = _field
	return nil
...
func (p *MemoryToolConfig) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("MemoryToolConfig"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
		if err = p.writeField1(oprot); err != nil {
...
func (p *MemoryToolConfig) writeField1(oprot thrift.TProtocol) (err error) {
	if p.IsSetMode() {
...
func (p *MemoryToolConfig) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("MemoryToolConfig(%+v)", *p)
...
type FieldItem struct {
	...
	Desc *string `thrift:"Desc,2,optional" form:"desc" json:"desc,omitempty"`
	// field type
	Type *FieldItemType `thrift:"Type,3,optional,FieldItemType" form:"type" json:"type,omitempty"`
	// Is it required?
...
type Database struct {
	...
	FieldList []*FieldItem `thrift:"FieldList,4,optional,list<FieldItem>" form:"field_list" json:"field_list,omitempty"`
	// Whether to support calling in Prompt, the default is supported
	PromptDisabled *bool           `thrift:"PromptDisabled,5,optional" form:"prompt_disabled" json:"prompt_disabled,omitempty"`
	RWMode         *BotTableRWMode `thrift:"RWMode,6,optional,BotTableRWMode" form:"rw_mode" json:"rw_mode,omitempty"`
}
...
type Agent struct {
	...
	// List of plugins
	PluginInfoList []*PluginInfo `thrift:"PluginInfoList,4,default,list<PluginInfo>" form:"plugin_info_list" json:"plugin_info_list"`
	// dataset
	Knowledge *Knowledge `thrift:"Knowledge,5" form:"knowledge" json:"knowledge"`
	// Workflow List
	WorkflowInfoList []*WorkflowInfo `thrift:"WorkflowInfoList,6,default,list<WorkflowInfo>" form:"workflow_info_list" json:"workflow_info_list"`
	// model configuration
	ModelInfo *ModelInfo `thrift:"ModelInfo,7" form:"model_info" json:"model_info"`
	// intent information
	Intents   []*Intent `thrift:"Intents,8,default,list<Intent>" form:"intents" json:"intents"`
	AgentType AgentType `thrift:"AgentType,9,default,AgentType" form:"agent_type" json:"agent_type"`
	// Is it a rootagent?
	...
	VersionCompat AgentVersionCompat `thrift:"VersionCompat,19,default,AgentVersionCompat" form:"version_compat" json:"version_compat"`
	...
	ReferenceInfoStatus *ReferenceInfoStatus `thrift:"ReferenceInfoStatus,22,optional,ReferenceInfoStatus" form:"reference_info_status" json:"reference_info_status,omitempty"`
	//Subbot update type
	UpdateType *ReferenceUpdateType `thrift:"UpdateType,23,optional,ReferenceUpdateType" form:"update_type" json:"update_type,omitempty"`
}
...
type Intent struct {
	...
	SessionType MultiAgentSessionType `thrift:"SessionType,4,default,MultiAgentSessionType" form:"session_type" json:"session_type"`
}
...
type TimeCapsuleInfo struct {
	TimeCapsuleMode      *TimeCapsuleMode      `thrift:"TimeCapsuleMode,1,optional,TimeCapsuleMode" form:"time_capsule_mode" json:"time_capsule_mode,omitempty"`
	DisablePromptCalling *DisablePromptCalling `thrift:"DisablePromptCalling,2,optional,DisablePromptCalling" form:"disable_prompt_calling" json:"disable_prompt_calling,omitempty"`
}
...
type FileboxInfo struct {
	Mode *FileboxInfoMode `thrift:"Mode,1,optional,FileboxInfoMode" form:"Mode" json:"Mode,omitempty" query:"Mode"`
}
...
type BotInfo struct {
	...
	// List of plugins
	PluginInfoList []*PluginInfo `thrift:"PluginInfoList,13,default,list<PluginInfo>" form:"plugin_info_list" json:"plugin_info_list"`
	// Workflow List
	WorkflowInfoList []*WorkflowInfo `thrift:"WorkflowInfoList,14,default,list<WorkflowInfo>" form:"workflow_info_list" json:"workflow_info_list"`
	// opening statement
	...
	// KV storage
	VariableList []*Variable `thrift:"VariableList,17,default,list<Variable>" form:"variable_list" json:"variable_list"`
	// Task management/preset tasks
	TaskInfo *TaskInfo `thrift:"TaskInfo,18" form:"task_info" json:"task_info"`
	// data table
	DatabaseList []*Database `thrift:"DatabaseList,19,default,list<Database>" form:"database_list" json:"database_list"`
	// referral question
	...
	BotMode BotMode `thrift:"BotMode,23,default,BotMode" form:"bot_mode" json:"bot_mode"`
	// Multi agent mode agent information
	Agents []*Agent `thrift:"Agents,24,default,list<Agent>" form:"agents" json:"agents"`
	// Bot type
	BotSpecies BotSpecies `thrift:"BotSpecies,25,default,BotSpecies" form:"bot_species" json:"bot_species"`
	...
	BackgroundImageInfoList []*BackgroundImageInfo `thrift:"BackgroundImageInfoList,29,default,list<BackgroundImageInfo>" form:"background_image_info_list" json:"background_image_info_list"`
	ShortcutSort            []string               `thrift:"ShortcutSort,30,default,list<string>" form:"shortcut_sort" json:"shortcut_sort"`
	// bot state
	Status BotStatus `thrift:"Status,31,default,BotStatus" form:"status" json:"status"`
	// Hook information
	...
	BusinessType BusinessType `thrift:"BusinessType,35,default,BusinessType" form:"business_type" json:"business_type"`
	// External Knowledge configuration for RAGFlow integration
	ExternalKnowledge *ExternalKnowledge `thrift:"ExternalKnowledge,36,optional" form:"external_knowledge" json:"external_knowledge,omitempty"`
	// Memory tool configuration (setKeywordMemory, getKeywordMemory, etc.)
	MemoryToolConfig *MemoryToolConfig `thrift:"MemoryToolConfig,37,optional" form:"memory_tool_config" json:"memory_tool_config,omitempty"`
	// Bound cards for agent prompt injection
	BoundCards []*BoundCardInfo `thrift:"BoundCards,38,optional,list<BoundCardInfo>" form:"bound_cards" json:"bound_cards,omitempty"`
	// Skills bound to this bot
...
var BotInfo_ExternalKnowledge_DEFAULT *ExternalKnowledge

func (p *BotInfo) GetExternalKnowledge() (v *ExternalKnowledge) {
	if !p.IsSetExternalKnowledge() {
		return BotInfo_ExternalKnowledge_DEFAULT
	}
	return p.ExternalKnowledge
}

var BotInfo_MemoryToolConfig_DEFAULT *MemoryToolConfig

func (p *BotInfo) GetMemoryToolConfig() (v *MemoryToolConfig) {
	if !p.IsSetMemoryToolConfig() {
		return BotInfo_MemoryToolConfig_DEFAULT
	}
	return p.MemoryToolConfig
}

var BotInfo_BoundCards_DEFAULT []*BoundCardInfo

func (p *BotInfo) GetBoundCards() (v []*BoundCardInfo) {
	if !p.IsSetBoundCards() {
		return BotInfo_BoundCards_DEFAULT
	}
	return p.BoundCards
}

var BotInfo_SkillInfoList_DEFAULT []*skill.SkillReference

func (p *BotInfo) GetSkillInfoList() (v []*skill.SkillReference) {
	if !p.IsSetSkillInfoList() {
		return BotInfo_SkillInfoList_DEFAULT
	}
	return p.SkillInfoList
}

var BotInfo_ForceToolReturn_DEFAULT bool

func (p *BotInfo) GetForceToolReturn() (v bool) {
	if !p.IsSetForceToolReturn() {
		return BotInfo_ForceToolReturn_DEFAULT
	}
	return *p.ForceToolReturn
}
...
func (p *BotInfo) IsSetExternalKnowledge() bool {
	return p.ExternalKnowledge != nil
}

func (p *BotInfo) IsSetMemoryToolConfig() bool {
	return p.MemoryToolConfig != nil
}

func (p *BotInfo) IsSetBoundCards() bool {
	return p.BoundCards != nil
}

func (p *BotInfo) IsSetSkillInfoList() bool {
	return p.SkillInfoList != nil
}

func (p *BotInfo) IsSetForceToolReturn() bool {
	return p.ForceToolReturn != nil
}
...
func (p *BotInfo) ReadField36(iprot thrift.TProtocol) error {
	_field := NewExternalKnowledge()
	if err := _field.Read(iprot); err != nil {
		return err
	}
	p.ExternalKnowledge = _field
	return nil
}
func (p *BotInfo) ReadField37(iprot thrift.TProtocol) error {
	_field := NewMemoryToolConfig()
	if err := _field.Read(iprot); err != nil {
		return err
	}
	p.MemoryToolConfig = _field
	return nil
}
func (p *BotInfo) ReadField38(iprot thrift.TProtocol) error {
	_, size, err := iprot.ReadListBegin()
	if err != nil {
		return err
	}
	_field := make([]*BoundCardInfo, 0, size)
	values := make([]BoundCardInfo, size)
	for i := 0; i < size; i++ {
		_elem := &values[i]
		_elem.InitDefault()
...
func (p *BotInfo) ReadField39(iprot thrift.TProtocol) error {
	_, size, err := iprot.ReadListBegin()
	if err != nil {
		return err
	}
	_field := make([]*skill.SkillReference, 0, size)
	values := make([]skill.SkillReference, size)
	for i := 0; i < size; i++ {
		_elem := &values[i]
		_elem.InitDefault()
	...
	p.SkillInfoList = _field
	return nil
}
func (p *BotInfo) ReadField40(iprot thrift.TProtocol) error {
...
func (p *BotInfo) writeField36(oprot thrift.TProtocol) (err error) {
	if p.IsSetExternalKnowledge() {
		if err = oprot.WriteFieldBegin("ExternalKnowledge", thrift.STRUCT, 36); err != nil {
			goto WriteFieldBeginError
		}
		if err := p.ExternalKnowledge.Write(oprot); err != nil {
			return err
		}
		if err = oprot.WriteFieldEnd(); err != nil {
			goto WriteFieldEndError
...
func (p *BotInfo) writeField37(oprot thrift.TProtocol) (err error) {
	if p.IsSetMemoryToolConfig() {
		if err = oprot.WriteFieldBegin("MemoryToolConfig", thrift.STRUCT, 37); err != nil {
			goto WriteFieldBeginError
		}
		if err := p.MemoryToolConfig.Write(oprot); err != nil {
			return err
		}
		if err = oprot.WriteFieldEnd(); err != nil {
			goto WriteFieldEndError
...
func (p *BotInfo) writeField38(oprot thrift.TProtocol) (err error) {
	if p.IsSetBoundCards() {
		if err = oprot.WriteFieldBegin("BoundCards", thrift.LIST, 38); err != nil {
			goto WriteFieldBeginError
		}
		if err := oprot.WriteListBegin(thrift.STRUCT, len(p.BoundCards)); err != nil {
			return err
		}
		for _, v := range p.BoundCards {
			if err := v.Write(oprot); err != nil {
				return err
			}
		}
...
func (p *BotInfo) writeField39(oprot thrift.TProtocol) (err error) {
	if p.IsSetSkillInfoList() {
		if err = oprot.WriteFieldBegin("SkillInfoList", thrift.LIST, 39); err != nil {
			goto WriteFieldBeginError
		}
		if err := oprot.WriteListBegin(thrift.STRUCT, len(p.SkillInfoList)); err != nil {
			return err
		}
		for _, v := range p.SkillInfoList {
			if err := v.Write(oprot); err != nil {
				return err
			}
		}
...
func (p *BotInfo) writeField40(oprot thrift.TProtocol) (err error) {
	if p.IsSetForceToolReturn() {
		if err = oprot.WriteFieldBegin("ForceToolReturn", thrift.BOOL, 40); err != nil {
			goto WriteFieldBeginError
		}
		if err := oprot.WriteBool(*p.ForceToolReturn); err != nil {
			return err
		}
		if err = oprot.WriteFieldEnd(); err != nil {
			goto WriteFieldEndError
...
type ExternalKnowledge struct {
	// List of dataset IDs from RAGFlow
	DatasetIds []string `thrift:"dataset_ids,1,optional,list<string>" form:"dataset_ids" json:"dataset_ids,omitempty"`
	// Number of chunks for vector computation, default 10
	TopK *int32 `thrift:"top_k,2,optional" form:"top_k" json:"top_k,omitempty"`
	// Max chunks per page, default 30
	PageSize *int32 `thrift:"page_size,3,optional" form:"page_size" json:"page_size,omitempty"`
	// Min similarity score, default 0.2
	SimilarityThreshold *float64 `thrift:"similarity_threshold,4,optional" form:"similarity_threshold" json:"similarity_threshold,omitempty"`
	// Weight of vector cosine similarity, default 0.3
	VectorSimilarityWeight *float64 `thrift:"vector_similarity_weight,5,optional" form:"vector_similarity_weight" json:"vector_similarity_weight,omitempty"`
	// ID of rerank model
	RerankID *int32 `thrift:"rerank_id,6,optional" form:"rerank_id" json:"rerank_id,omitempty"`
	// Enable keyword matching, default false
	Keyword *bool `thrift:"keyword,7,optional" form:"keyword" json:"keyword,omitempty"`
	// Enable term highlighting, default false
	Highlight *bool `thrift:"highlight,8,optional" form:"highlight" json:"highlight,omitempty"`
	// Languages for translation
	CrossLanguages []string `thrift:"cross_languages,9,optional,list<string>" form:"cross_languages" json:"cross_languages,omitempty"`
	// Description to help LLM understand the knowledge base purpose
	Description *string `thrift:"description,10,optional" form:"description" json:"description,omitempty"`
	// Custom name for the knowledge base configuration
	Name *string `thrift:"name,11,optional" form:"name" json:"name,omitempty"`
}

func NewExternalKnowledge() *ExternalKnowledge {
	return &ExternalKnowledge{}
}

func (p *ExternalKnowledge) InitDefault() {
}

var ExternalKnowledge_DatasetIds_DEFAULT []string

func (p *ExternalKnowledge) GetDatasetIds() (v []string) {
	if !p.IsSetDatasetIds() {
		return ExternalKnowledge_DatasetIds_DEFAULT
	}
	return p.DatasetIds
}

var ExternalKnowledge_TopK_DEFAULT int32

func (p *ExternalKnowledge) GetTopK() (v int32) {
	if !p.IsSetTopK() {
		return ExternalKnowledge_TopK_DEFAULT
	}
	return *p.TopK
}

var ExternalKnowledge_PageSize_DEFAULT int32

func (p *ExternalKnowledge) GetPageSize() (v int32) {
	if !p.IsSetPageSize() {
		return ExternalKnowledge_PageSize_DEFAULT
	}
	return *p.PageSize
}

var ExternalKnowledge_SimilarityThreshold_DEFAULT float64

func (p *ExternalKnowledge) GetSimilarityThreshold() (v float64) {
	if !p.IsSetSimilarityThreshold() {
		return ExternalKnowledge_SimilarityThreshold_DEFAULT
	}
	return *p.SimilarityThreshold
}

var ExternalKnowledge_VectorSimilarityWeight_DEFAULT float64

func (p *ExternalKnowledge) GetVectorSimilarityWeight() (v float64) {
	if !p.IsSetVectorSimilarityWeight() {
		return ExternalKnowledge_VectorSimilarityWeight_DEFAULT
	}
	return *p.VectorSimilarityWeight
}

var ExternalKnowledge_RerankID_DEFAULT int32

func (p *ExternalKnowledge) GetRerankID() (v int32) {
	if !p.IsSetRerankID() {
		return ExternalKnowledge_RerankID_DEFAULT
	}
	return *p.RerankID
}

var ExternalKnowledge_Keyword_DEFAULT bool

func (p *ExternalKnowledge) GetKeyword() (v bool) {
	if !p.IsSetKeyword() {
		return ExternalKnowledge_Keyword_DEFAULT
	}
	return *p.Keyword
}

var ExternalKnowledge_Highlight_DEFAULT bool

func (p *ExternalKnowledge) GetHighlight() (v bool) {
	if !p.IsSetHighlight() {
		return ExternalKnowledge_Highlight_DEFAULT
	}
	return *p.Highlight
}

var ExternalKnowledge_CrossLanguages_DEFAULT []string

func (p *ExternalKnowledge) GetCrossLanguages() (v []string) {
	if !p.IsSetCrossLanguages() {
		return ExternalKnowledge_CrossLanguages_DEFAULT
	}
	return p.CrossLanguages
}

var ExternalKnowledge_Description_DEFAULT string

func (p *ExternalKnowledge) GetDescription() (v string) {
	if !p.IsSetDescription() {
		return ExternalKnowledge_Description_DEFAULT
	}
	return *p.Description
}

var ExternalKnowledge_Name_DEFAULT string

func (p *ExternalKnowledge) GetName() (v string) {
	if !p.IsSetName() {
		return ExternalKnowledge_Name_DEFAULT
	}
	return *p.Name
}

var fieldIDToName_ExternalKnowledge = map[int16]string{
	1:  "dataset_ids",
	2:  "top_k",
	3:  "page_size",
	4:  "similarity_threshold",
	5:  "vector_similarity_weight",
	6:  "rerank_id",
	7:  "keyword",
	8:  "highlight",
	9:  "cross_languages",
...
func (p *ExternalKnowledge) IsSetDatasetIds() bool {
	return p.DatasetIds != nil
}

func (p *ExternalKnowledge) IsSetTopK() bool {
	return p.TopK != nil
}

func (p *ExternalKnowledge) IsSetPageSize() bool {
	return p.PageSize != nil
}

func (p *ExternalKnowledge) IsSetSimilarityThreshold() bool {
	return p.SimilarityThreshold != nil
}

func (p *ExternalKnowledge) IsSetVectorSimilarityWeight() bool {
	return p.VectorSimilarityWeight != nil
}

func (p *ExternalKnowledge) IsSetRerankID() bool {
	return p.RerankID != nil
}

func (p *ExternalKnowledge) IsSetKeyword() bool {
	return p.Keyword != nil
}

func (p *ExternalKnowledge) IsSetHighlight() bool {
	return p.Highlight != nil
}

func (p *ExternalKnowledge) IsSetCrossLanguages() bool {
	return p.CrossLanguages != nil
}

func (p *ExternalKnowledge) IsSetDescription() bool {
	return p.Description != nil
}

func (p *ExternalKnowledge) IsSetName() bool {
	return p.Name != nil
}

func (p *ExternalKnowledge) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_ExternalKnowledge[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *ExternalKnowledge) ReadField1(iprot thrift.TProtocol) error {
	_, size, err := iprot.ReadListBegin()
	if err != nil {
		return err
	}
...
func (p *ExternalKnowledge) ReadField2(iprot thrift.TProtocol) error {
...
func (p *ExternalKnowledge) ReadField3(iprot thrift.TProtocol) error {
...
func (p *ExternalKnowledge) ReadField4(iprot thrift.TProtocol) error {
	...
	p.SimilarityThreshold = _field
	return nil
}
func (p *ExternalKnowledge) ReadField5(iprot thrift.TProtocol) error {
	...
	p.VectorSimilarityWeight = _field
	return nil
}
func (p *ExternalKnowledge) ReadField6(iprot thrift.TProtocol) error {
...
func (p *ExternalKnowledge) ReadField7(iprot thrift.TProtocol) error {
...
func (p *ExternalKnowledge) ReadField8(iprot thrift.TProtocol) error {
...
func (p *ExternalKnowledge) ReadField9(iprot thrift.TProtocol) error {
	_, size, err := iprot.ReadListBegin()
	if err != nil {
		return err
	}
	...
	p.CrossLanguages = _field
	return nil
}
func (p *ExternalKnowledge) ReadField10(iprot thrift.TProtocol) error {
...
func (p *ExternalKnowledge) ReadField11(iprot thrift.TProtocol) error {
...
func (p *ExternalKnowledge) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("ExternalKnowledge"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
		if err = p.writeField1(oprot); err != nil {
...
func (p *ExternalKnowledge) writeField1(oprot thrift.TProtocol) (err error) {
	if p.IsSetDatasetIds() {
...
func (p *ExternalKnowledge) writeField2(oprot thrift.TProtocol) (err error) {
	if p.IsSetTopK() {
		if err = oprot.WriteFieldBegin("top_k", thrift.I32, 2); err != nil {
			goto WriteFieldBeginError
		}
		if err := oprot.WriteI32(*p.TopK); err != nil {
			return err
...
func (p *ExternalKnowledge) writeField3(oprot thrift.TProtocol) (err error) {
	if p.IsSetPageSize() {
...
func (p *ExternalKnowledge) writeField4(oprot thrift.TProtocol) (err error) {
	if p.IsSetSimilarityThreshold() {
		if err = oprot.WriteFieldBegin("similarity_threshold", thrift.DOUBLE, 4); err != nil {
			goto WriteFieldBeginError
		}
		if err := oprot.WriteDouble(*p.SimilarityThreshold); err != nil {
			return err
		}
		if err = oprot.WriteFieldEnd(); err != nil {
			goto WriteFieldEndError
...
func (p *ExternalKnowledge) writeField5(oprot thrift.TProtocol) (err error) {
	if p.IsSetVectorSimilarityWeight() {
		if err = oprot.WriteFieldBegin("vector_similarity_weight", thrift.DOUBLE, 5); err != nil {
			goto WriteFieldBeginError
		}
		if err := oprot.WriteDouble(*p.VectorSimilarityWeight); err != nil {
			return err
		}
		if err = oprot.WriteFieldEnd(); err != nil {
			goto WriteFieldEndError
...
func (p *ExternalKnowledge) writeField6(oprot thrift.TProtocol) (err error) {
	if p.IsSetRerankID() {
		if err = oprot.WriteFieldBegin("rerank_id", thrift.I32, 6); err != nil {
			goto WriteFieldBeginError
		}
		if err := oprot.WriteI32(*p.RerankID); err != nil {
			return err
		}
		if err = oprot.WriteFieldEnd(); err != nil {
			goto WriteFieldEndError
...
func (p *ExternalKnowledge) writeField7(oprot thrift.TProtocol) (err error) {
	if p.IsSetKeyword() {
		if err = oprot.WriteFieldBegin("keyword", thrift.BOOL, 7); err != nil {
			goto WriteFieldBeginError
		}
		if err := oprot.WriteBool(*p.Keyword); err != nil {
			return err
		}
		if err = oprot.WriteFieldEnd(); err != nil {
			goto WriteFieldEndError
...
func (p *ExternalKnowledge) writeField8(oprot thrift.TProtocol) (err error) {
	if p.IsSetHighlight() {
		if err = oprot.WriteFieldBegin("highlight", thrift.BOOL, 8); err != nil {
			goto WriteFieldBeginError
		}
...
func (p *ExternalKnowledge) writeField9(oprot thrift.TProtocol) (err error) {
	if p.IsSetCrossLanguages() {
		if err = oprot.WriteFieldBegin("cross_languages", thrift.LIST, 9); err != nil {
			goto WriteFieldBeginError
		}
		if err := oprot.WriteListBegin(thrift.STRING, len(p.CrossLanguages)); err != nil {
			return err
		}
		for _, v := range p.CrossLanguages {
			if err := oprot.WriteString(v); err != nil {
				return err
			}
		}
...
func (p *ExternalKnowledge) writeField10(oprot thrift.TProtocol) (err error) {
	if p.IsSetDescription() {
...
func (p *ExternalKnowledge) writeField11(oprot thrift.TProtocol) (err error) {
	if p.IsSetName() {
...
func (p *ExternalKnowledge) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("ExternalKnowledge(%+v)", *p)

}

type CommonKnowledge struct {
	// Knowledge Base Information
	KnowledgeInfos []*KnowledgeInfo `thrift:"knowledge_infos,1,default,list<KnowledgeInfo>" form:"knowledge_infos" json:"knowledge_infos" query:"knowledge_infos"`
}
...
type ShortcutCommandComponent struct {
	...
	Options []string `thrift:"options,5,optional,list<string>" form:"options" json:"options,omitempty" query:"options"`
...
type ShortcutCommandInfo struct {
	...
	Components []*ShortcutCommandComponent `thrift:"components,7,optional,list<ShortcutCommandComponent>" form:"components" json:"components,omitempty" query:"components"`
	// Tool information
...
type OpenAPIBotInfo struct {
	...
	// Bot type, single agent or multi agent
	BotMode BotMode `thrift:"bot_mode,10,default,BotMode" form:"bot_mode" json:"bot_mode" query:"bot_mode"`
	...
	PluginInfoList []*PluginInfo `thrift:"plugin_info_list,13,default,list<PluginInfo>" form:"plugin_info_list" json:"plugin_info_list" query:"plugin_info_list"`
	// Knowledge Base Information
	...
	WorkflowInfoList []*WorkflowInfo `thrift:"workflow_info_list,15,default,list<WorkflowInfo>" form:"workflow_info_list" json:"workflow_info_list" query:"workflow_info_list"`
	// Quick Command Information List
	ShortcutCommands []*ShortcutCommandInfo `thrift:"shortcut_commands,16,default,list<ShortcutCommandInfo>" form:"shortcut_commands" json:"shortcut_commands" query:"shortcut_commands"`
	...
	// Variable list
	Variables []*Variable `thrift:"variables,21,default,list<Variable>" form:"variables" json:"variables" query:"variables"`
}
...
type MultiAgentInfo struct {
	...
	SessionType MultiAgentSessionType `thrift:"SessionType,1,default,MultiAgentSessionType" form:"session_type" json:"session_type"`
	...
	ConnectorType MultiAgentConnectorType `thrift:"ConnectorType,3,default,MultiAgentConnectorType" form:"connector_type" json:"connector_type"`
}
...
type AgentVersionCompatInfo struct {
	VersionCompat AgentVersionCompat `thrift:"VersionCompat,1,default,AgentVersionCompat" form:"version_compat" json:"version_compat"`
...
type BotInfoForUpdate struct {
	...
	// List of plugins
	PluginInfoList []*PluginInfo `thrift:"PluginInfoList,13,optional,list<PluginInfo>" form:"plugin_info_list" json:"plugin_info_list,omitempty"`
	// Workflow List
	WorkflowInfoList []*WorkflowInfo `thrift:"WorkflowInfoList,14,optional,list<WorkflowInfo>" form:"workflow_info_list" json:"workflow_info_list,omitempty"`
	// opening statement
	...
	// KV storage
	VariableList []*Variable `thrift:"VariableList,17,optional,list<Variable>" form:"variable_list" json:"variable_list,omitempty"`
	// Task management/preset tasks
	TaskInfo *TaskInfo `thrift:"TaskInfo,18,optional" form:"task_info" json:"task_info,omitempty"`
	// data table
	DatabaseList []*Database `thrift:"DatabaseList,19,optional,list<Database>" form:"database_list" json:"database_list,omitempty"`
	// referral question
	...
	// Bot type, single agent or multi agent
	BotMode *BotMode `thrift:"BotMode,23,optional,BotMode" form:"bot_mode" json:"bot_mode,omitempty"`
	// Multi agent mode agent information
	Agents []*AgentForUpdate `thrift:"Agents,24,optional,list<AgentForUpdate>" form:"agents" json:"agents,omitempty"`
	// Bot type
	BotSpecies BotSpecies `thrift:"BotSpecies,25,default,BotSpecies" form:"bot_species" json:"bot_species"`
	// Bot tag information, user new field
	...
	// Background cover list structure
	BackgroundImageInfoList []*BackgroundImageInfo `thrift:"BackgroundImageInfoList,29,optional,list<BackgroundImageInfo>" form:"background_image_info_list" json:"background_image_info_list,omitempty"`
	ShortcutSort            []string               `thrift:"ShortcutSort,30,optional,list<string>" form:"shortcut_sort" json:"shortcut_sort,omitempty"`
	...
	// External Knowledge configuration for RAGFlow integration
	ExternalKnowledge *ExternalKnowledge `thrift:"ExternalKnowledge,34,optional" form:"external_knowledge" json:"external_knowledge,omitempty"`
	// Memory tool configuration
	MemoryToolConfig *MemoryToolConfig `thrift:"MemoryToolConfig,35,optional" form:"memory_tool_config" json:"memory_tool_config,omitempty"`
	// Bound cards for agent prompt injection
	BoundCards []*BoundCardInfo `thrift:"BoundCards,36,optional,list<BoundCardInfo>" form:"bound_cards" json:"bound_cards,omitempty"`
	// Skills bound to this bot
...
var BotInfoForUpdate_ExternalKnowledge_DEFAULT *ExternalKnowledge

func (p *BotInfoForUpdate) GetExternalKnowledge() (v *ExternalKnowledge) {
	if !p.IsSetExternalKnowledge() {
		return BotInfoForUpdate_ExternalKnowledge_DEFAULT
	}
	return p.ExternalKnowledge
}

var BotInfoForUpdate_MemoryToolConfig_DEFAULT *MemoryToolConfig

func (p *BotInfoForUpdate) GetMemoryToolConfig() (v *MemoryToolConfig) {
	if !p.IsSetMemoryToolConfig() {
		return BotInfoForUpdate_MemoryToolConfig_DEFAULT
	}
	return p.MemoryToolConfig
}

var BotInfoForUpdate_BoundCards_DEFAULT []*BoundCardInfo

func (p *BotInfoForUpdate) GetBoundCards() (v []*BoundCardInfo) {
	if !p.IsSetBoundCards() {
		return BotInfoForUpdate_BoundCards_DEFAULT
	}
	return p.BoundCards
}

var BotInfoForUpdate_SkillInfoList_DEFAULT []*skill.SkillReference

func (p *BotInfoForUpdate) GetSkillInfoList() (v []*skill.SkillReference) {
	if !p.IsSetSkillInfoList() {
		return BotInfoForUpdate_SkillInfoList_DEFAULT
	}
	return p.SkillInfoList
}

var BotInfoForUpdate_ForceToolReturn_DEFAULT bool

func (p *BotInfoForUpdate) GetForceToolReturn() (v bool) {
	if !p.IsSetForceToolReturn() {
		return BotInfoForUpdate_ForceToolReturn_DEFAULT
	}
	return *p.ForceToolReturn
}
...
func (p *BotInfoForUpdate) IsSetExternalKnowledge() bool {
	return p.ExternalKnowledge != nil
}

func (p *BotInfoForUpdate) IsSetMemoryToolConfig() bool {
	return p.MemoryToolConfig != nil
}

func (p *BotInfoForUpdate) IsSetBoundCards() bool {
	return p.BoundCards != nil
}

func (p *BotInfoForUpdate) IsSetSkillInfoList() bool {
	return p.SkillInfoList != nil
}

func (p *BotInfoForUpdate) IsSetForceToolReturn() bool {
	return p.ForceToolReturn != nil
}
...
func (p *BotInfoForUpdate) ReadField34(iprot thrift.TProtocol) error {
	_field := NewExternalKnowledge()
	if err := _field.Read(iprot); err != nil {
		return err
	}
...
func (p *BotInfoForUpdate) ReadField35(iprot thrift.TProtocol) error {
	_field := NewMemoryToolConfig()
	if err := _field.Read(iprot); err != nil {
		return err
	}
...
func (p *BotInfoForUpdate) ReadField36(iprot thrift.TProtocol) error {
	_, size, err := iprot.ReadListBegin()
	if err != nil {
		return err
	}
...
func (p *BotInfoForUpdate) ReadField37(iprot thrift.TProtocol) error {
	_, size, err := iprot.ReadListBegin()
	if err != nil {
		return err
	}
...
func (p *BotInfoForUpdate) ReadField38(iprot thrift.TProtocol) error {
...
func (p *BotInfoForUpdate) writeField34(oprot thrift.TProtocol) (err error) {
	if p.IsSetExternalKnowledge() {
		if err = oprot.WriteFieldBegin("ExternalKnowledge", thrift.STRUCT, 34); err != nil {
			goto WriteFieldBeginError
		}
		if err := p.ExternalKnowledge.Write(oprot); err != nil {
			return err
...
func (p *BotInfoForUpdate) writeField35(oprot thrift.TProtocol) (err error) {
	if p.IsSetMemoryToolConfig() {
		if err = oprot.WriteFieldBegin("MemoryToolConfig", thrift.STRUCT, 35); err != nil {
			goto WriteFieldBeginError
		}
		if err := p.MemoryToolConfig.Write(oprot); err != nil {
			return err
...
func (p *BotInfoForUpdate) writeField36(oprot thrift.TProtocol) (err error) {
	if p.IsSetBoundCards() {
		if err = oprot.WriteFieldBegin("BoundCards", thrift.LIST, 36); err != nil {
			goto WriteFieldBeginError
		}
		if err := oprot.WriteListBegin(thrift.STRUCT, len(p.BoundCards)); err != nil {
			return err
...
func (p *BotInfoForUpdate) writeField37(oprot thrift.TProtocol) (err error) {
	if p.IsSetSkillInfoList() {
		if err = oprot.WriteFieldBegin("SkillInfoList", thrift.LIST, 37); err != nil {
			goto WriteFieldBeginError
		}
		if err := oprot.WriteListBegin(thrift.STRUCT, len(p.SkillInfoList)); err != nil {
			return err
...
func (p *BotInfoForUpdate) writeField38(oprot thrift.TProtocol) (err error) {
	if p.IsSetForceToolReturn() {
		if err = oprot.WriteFieldBegin("ForceToolReturn", thrift.BOOL, 38); err != nil {
			goto WriteFieldBeginError
		}
		if err := oprot.WriteBool(*p.ForceToolReturn); err != nil {
			return err
...
type AgentForUpdate struct {
	...
	// List of plugins
	PluginInfoList []*PluginInfo `thrift:"PluginInfoList,4,optional,list<PluginInfo>" form:"plugin_info_list" json:"plugin_info_list,omitempty"`
	// dataset
	Knowledge *Knowledge `thrift:"Knowledge,5,optional" form:"knowledge" json:"knowledge,omitempty"`
	// Workflow List
	WorkflowInfoList []*WorkflowInfo `thrift:"WorkflowInfoList,6,optional,list<WorkflowInfo>" form:"workflow_info_list" json:"workflow_info_list,omitempty"`
	// model configuration
	ModelInfo *ModelInfo `thrift:"ModelInfo,7,optional" form:"model_info" json:"model_info,omitempty"`
	// intent information
	Intents   []*Intent  `thrift:"Intents,8,optional,list<Intent>" form:"intents" json:"intents,omitempty"`
	AgentType *AgentType `thrift:"AgentType,9,optional,AgentType" form:"agent_type" json:"agent_type,omitempty"`
	// Is it a rootagent?
	...
	// multi_agent version compatibility field
	VersionCompat *AgentVersionCompat `thrift:"VersionCompat,19,optional,AgentVersionCompat" form:"version_compat" json:"version_compat,omitempty"`
	HookInfo      *HookInfo           `thrift:"HookInfo,20,optional" form:"hook_info" json:"hook_info,omitempty"`
}
...
type TableDetail struct {
	...
	// Table field information
	FieldList []*FieldItem `thrift:"FieldList,4,optional,list<FieldItem>" form:"FieldList" json:"FieldList,omitempty" query:"FieldList"`
	// Whether to support calling in Prompt, the default is supported
	PromptDisabled *bool `thrift:"PromptDisabled,5,optional" form:"prompt_disabled" json:"prompt_disabled,omitempty"`
}
...
type TaskPluginInput struct {
	Params []*TaskPluginInputField `thrift:"Params,1,optional,list<TaskPluginInputField>" form:"Params" json:"Params,omitempty" query:"Params"`
}
...
type TaskWebhookField struct {
	...
	Children    []*TaskWebhookField `thrift:"Children,4,optional,list<TaskWebhookField>" form:"Children" json:"Children,omitempty" query:"Children"`
}
...
type TaskWebhookOutput struct {
	Params []*TaskWebhookField `thrift:"Params,1,optional,list<TaskWebhookField>" form:"Params" json:"Params,omitempty" query:"Params"`
}
...
type JumpConfig struct {
	Backtrack       BacktrackMode          `thrift:"backtrack,1,default,BacktrackMode" form:"backtrack" json:"backtrack" query:"backtrack"`
	Recognition     RecognitionMode        `thrift:"recognition,2,default,RecognitionMode" form:"recognition" json:"recognition" query:"recognition"`
...
type IndependentModeConfig struct {
	// judge timing
	JudgeTiming  IndependentTiming               `thrift:"judge_timing,1,default,IndependentTiming" form:"judge_timing" json:"judge_timing" query:"judge_timing"`
	HistoryRound int32                           `thrift:"history_round,2" form:"history_round" json:"history_round" query:"history_round"`
	ModelType    IndependentRecognitionModelType `thrift:"model_type,3,default,IndependentRecognitionModelType" form:"model_type" json:"model_type" query:"model_type"`
...
type MessageFeedback struct {
	// feedback type
	FeedbackType MessageFeedbackType `thrift:"feedback_type,1,default,MessageFeedbackType" form:"feedback_type" json:"feedback_type" query:"feedback_type"`
	// segmentation type
	DetailTypes []MessageFeedbackDetailType `thrift:"detail_types,2,default,list<MessageFeedbackDetailType>" form:"detail_types" json:"detail_types" query:"detail_types"`
...
type HookInfo struct {
	// Pre agent jump hook
	PreAgentJumpHook []*HookItem `thrift:"pre_agent_jump_hook,1,optional,list<HookItem>" form:"pre_agent_jump_hook" json:"pre_agent_jump_hook,omitempty" query:"pre_agent_jump_hook"`
	// Post agent jump hook
	PostAgentJumpHook []*HookItem `thrift:"post_agent_jump_hook,2,optional,list<HookItem>" form:"post_agent_jump_hook" json:"post_agent_jump_hook,omitempty" query:"post_agent_jump_hook"`
	// Process hook
	FlowHook []*HookItem `thrift:"flow_hook,3,optional,list<HookItem>" form:"flow_hook" json:"flow_hook,omitempty" query:"flow_hook"`
	// Atomic power hook
	AtomicHook []*HookItem `thrift:"atomic_hook,4,optional,list<HookItem>" form:"atomic_hook" json:"atomic_hook,omitempty" query:"atomic_hook"`
	// Model call hook
	LlmCallHook []*HookItem `thrift:"llm_call_hook,5,optional,list<HookItem>" form:"llm_call_hook" json:"llm_call_hook,omitempty" query:"llm_call_hook"`
	// Conversation result hook
	ResParsingHook []*HookItem `thrift:"res_parsing_hook,6,optional,list<HookItem>" form:"res_parsing_hook" json:"res_parsing_hook,omitempty" query:"res_parsing_hook"`
	// suggesion hook
	SuggestionHook []*HookItem `thrift:"suggestion_hook,7,optional,list<HookItem>" form:"suggestion_hook" json:"suggestion_hook,omitempty" query:"suggestion_hook"`
}
...
type HookItem struct {
	...
	FilterRules []string `thrift:"filter_rules,2,optional,list<string>" form:"filter_rules" json:"filter_rules,omitempty" query:"filter_rules"`
...
type CardParam struct {
	// Parameter name
	ParamName *string `thrift:"param_name,1,optional" form:"param_name" json:"param_name,omitempty"`
	// Parameter type
	ParamType *string `thrift:"param_type,2,optional" form:"param_type" json:"param_type,omitempty"`
	// Whether required
	Required *bool `thrift:"required,3,optional" form:"required" json:"required,omitempty"`
	// Parameter description
	Desc *string `thrift:"desc,4,optional" form:"desc" json:"desc,omitempty"`
	// Nested parameters
	Children []*CardParam `thrift:"children,5,optional,list<CardParam>" form:"children" json:"children,omitempty"`
}

func NewCardParam() *CardParam {
	return &CardParam{}
}

func (p *CardParam) InitDefault() {
}

var CardParam_ParamName_DEFAULT string

func (p *CardParam) GetParamName() (v string) {
	if !p.IsSetParamName() {
		return CardParam_ParamName_DEFAULT
	}
	return *p.ParamName
}

var CardParam_ParamType_DEFAULT string

func (p *CardParam) GetParamType() (v string) {
	if !p.IsSetParamType() {
		return CardParam_ParamType_DEFAULT
	}
	return *p.ParamType
}

var CardParam_Required_DEFAULT bool

func (p *CardParam) GetRequired() (v bool) {
	if !p.IsSetRequired() {
		return CardParam_Required_DEFAULT
	}
	return *p.Required
}

var CardParam_Desc_DEFAULT string

func (p *CardParam) GetDesc() (v string) {
	if !p.IsSetDesc() {
		return CardParam_Desc_DEFAULT
	}
	return *p.Desc
}

var CardParam_Children_DEFAULT []*CardParam

func (p *CardParam) GetChildren() (v []*CardParam) {
	if !p.IsSetChildren() {
		return CardParam_Children_DEFAULT
	}
	return p.Children
}

var fieldIDToName_CardParam = map[int16]string{
	1: "param_name",
	2: "param_type",
	3: "required",
	4: "desc",
...
func (p *CardParam) IsSetParamName() bool {
	return p.ParamName != nil
}

func (p *CardParam) IsSetParamType() bool {
	return p.ParamType != nil
}

func (p *CardParam) IsSetRequired() bool {
	return p.Required != nil
}

func (p *CardParam) IsSetDesc() bool {
	return p.Desc != nil
}

func (p *CardParam) IsSetChildren() bool {
	return p.Children != nil
}

func (p *CardParam) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_CardParam[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *CardParam) ReadField1(iprot thrift.TProtocol) error {
...
func (p *CardParam) ReadField2(iprot thrift.TProtocol) error {
...
func (p *CardParam) ReadField3(iprot thrift.TProtocol) error {
...
func (p *CardParam) ReadField4(iprot thrift.TProtocol) error {
...
func (p *CardParam) ReadField5(iprot thrift.TProtocol) error {
	_, size, err := iprot.ReadListBegin()
	if err != nil {
		return err
	}
	_field := make([]*CardParam, 0, size)
	values := make([]CardParam, size)
	for i := 0; i < size; i++ {
		_elem := &values[i]
		_elem.InitDefault()
...
func (p *CardParam) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("CardParam"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
		if err = p.writeField1(oprot); err != nil {
...
func (p *CardParam) writeField1(oprot thrift.TProtocol) (err error) {
	if p.IsSetParamName() {
		if err = oprot.WriteFieldBegin("param_name", thrift.STRING, 1); err != nil {
			goto WriteFieldBeginError
		}
...
func (p *CardParam) writeField2(oprot thrift.TProtocol) (err error) {
	if p.IsSetParamType() {
		if err = oprot.WriteFieldBegin("param_type", thrift.STRING, 2); err != nil {
			goto WriteFieldBeginError
		}
		if err := oprot.WriteString(*p.ParamType); err != nil {
			return err
		}
		if err = oprot.WriteFieldEnd(); err != nil {
			goto WriteFieldEndError
...
func (p *CardParam) writeField3(oprot thrift.TProtocol) (err error) {
	if p.IsSetRequired() {
		if err = oprot.WriteFieldBegin("required", thrift.BOOL, 3); err != nil {
			goto WriteFieldBeginError
		}
...
func (p *CardParam) writeField4(oprot thrift.TProtocol) (err error) {
	if p.IsSetDesc() {
...
func (p *CardParam) writeField5(oprot thrift.TProtocol) (err error) {
	if p.IsSetChildren() {
...
func (p *CardParam) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("CardParam(%+v)", *p)

}

// Card parameter mapping configuration
type CardParamMapping struct {
	// Card parameter name
	ParamName *string `thrift:"param_name,1,optional" form:"param_name" json:"param_name,omitempty"`
	// Mapped agent variable name
	VariableName *string `thrift:"variable_name,2,optional" form:"variable_name" json:"variable_name,omitempty"`
}

func NewCardParamMapping() *CardParamMapping {
	return &CardParamMapping{}
}

func (p *CardParamMapping) InitDefault() {
}

var CardParamMapping_ParamName_DEFAULT string

func (p *CardParamMapping) GetParamName() (v string) {
	if !p.IsSetParamName() {
		return CardParamMapping_ParamName_DEFAULT
	}
	return *p.ParamName
}

var CardParamMapping_VariableName_DEFAULT string

func (p *CardParamMapping) GetVariableName() (v string) {
	if !p.IsSetVariableName() {
		return CardParamMapping_VariableName_DEFAULT
	}
	return *p.VariableName
}

var fieldIDToName_CardParamMapping = map[int16]string{
	1: "param_name",
	2: "variable_name",
}

func (p *CardParamMapping) IsSetParamName() bool {
	return p.ParamName != nil
}

func (p *CardParamMapping) IsSetVariableName() bool {
	return p.VariableName != nil
}

func (p *CardParamMapping) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_CardParamMapping[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *CardParamMapping) ReadField1(iprot thrift.TProtocol) error {
...
func (p *CardParamMapping) ReadField2(iprot thrift.TProtocol) error {
	...
	p.VariableName = _field
	return nil
}

func (p *CardParamMapping) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("CardParamMapping"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
		if err = p.writeField1(oprot); err != nil {
...
func (p *CardParamMapping) writeField1(oprot thrift.TProtocol) (err error) {
	if p.IsSetParamName() {
		if err = oprot.WriteFieldBegin("param_name", thrift.STRING, 1); err != nil {
			goto WriteFieldBeginError
		}
...
func (p *CardParamMapping) writeField2(oprot thrift.TProtocol) (err error) {
	if p.IsSetVariableName() {
		if err = oprot.WriteFieldBegin("variable_name", thrift.STRING, 2); err != nil {
			goto WriteFieldBeginError
		}
		if err := oprot.WriteString(*p.VariableName); err != nil {
			return err
		}
		if err = oprot.WriteFieldEnd(); err != nil {
			goto WriteFieldEndError
...
func (p *CardParamMapping) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("CardParamMapping(%+v)", *p)

}

// Bound card information for agent
type BoundCardInfo struct {
	// Card ID (string to avoid JS precision loss)
	CardID *string `thrift:"card_id,1,optional" form:"card_id" json:"card_id,omitempty"`
	// Card name
	CardName *string `thrift:"card_name,2,optional" form:"card_name" json:"card_name,omitempty"`
	// Card code/identifier
	Code *string `thrift:"code,3,optional" form:"code" json:"code,omitempty"`
	// Card preview image URL
	CardPicURL *string `thrift:"card_pic_url,4,optional" form:"card_pic_url" json:"card_pic_url,omitempty"`
	// Card parameter list
	ParamList []*CardParam `thrift:"param_list,5,optional,list<CardParam>" form:"param_list" json:"param_list,omitempty"`
	// Parameter mapping configuration
	ParamMapping []*CardParamMapping `thrift:"param_mapping,6,optional,list<CardParamMapping>" form:"param_mapping" json:"param_mapping,omitempty"`
}

func NewBoundCardInfo() *BoundCardInfo {
	return &BoundCardInfo{}
}

func (p *BoundCardInfo) InitDefault() {
}

var BoundCardInfo_CardID_DEFAULT string

func (p *BoundCardInfo) GetCardID() (v string) {
	if !p.IsSetCardID() {
		return BoundCardInfo_CardID_DEFAULT
	}
	return *p.CardID
}

var BoundCardInfo_CardName_DEFAULT string

func (p *BoundCardInfo) GetCardName() (v string) {
	if !p.IsSetCardName() {
		return BoundCardInfo_CardName_DEFAULT
	}
	return *p.CardName
}

var BoundCardInfo_Code_DEFAULT string

func (p *BoundCardInfo) GetCode() (v string) {
	if !p.IsSetCode() {
		return BoundCardInfo_Code_DEFAULT
	}
	return *p.Code
}

var BoundCardInfo_CardPicURL_DEFAULT string

func (p *BoundCardInfo) GetCardPicURL() (v string) {
	if !p.IsSetCardPicURL() {
		return BoundCardInfo_CardPicURL_DEFAULT
	}
	return *p.CardPicURL
}

var BoundCardInfo_ParamList_DEFAULT []*CardParam

func (p *BoundCardInfo) GetParamList() (v []*CardParam) {
	if !p.IsSetParamList() {
		return BoundCardInfo_ParamList_DEFAULT
	}
	return p.ParamList
}

var BoundCardInfo_ParamMapping_DEFAULT []*CardParamMapping

func (p *BoundCardInfo) GetParamMapping() (v []*CardParamMapping) {
	if !p.IsSetParamMapping() {
		return BoundCardInfo_ParamMapping_DEFAULT
	}
	return p.ParamMapping
}

var fieldIDToName_BoundCardInfo = map[int16]string{
	1: "card_id",
	2: "card_name",
	3: "code",
	4: "card_pic_url",
...
func (p *BoundCardInfo) IsSetCardID() bool {
	return p.CardID != nil
}

func (p *BoundCardInfo) IsSetCardName() bool {
	return p.CardName != nil
}

func (p *BoundCardInfo) IsSetCode() bool {
	return p.Code != nil
}

func (p *BoundCardInfo) IsSetCardPicURL() bool {
	return p.CardPicURL != nil
}

func (p *BoundCardInfo) IsSetParamList() bool {
	return p.ParamList != nil
}

func (p *BoundCardInfo) IsSetParamMapping() bool {
	return p.ParamMapping != nil
}

func (p *BoundCardInfo) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_BoundCardInfo[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *BoundCardInfo) ReadField1(iprot thrift.TProtocol) error {
...
func (p *BoundCardInfo) ReadField2(iprot thrift.TProtocol) error {
...
func (p *BoundCardInfo) ReadField3(iprot thrift.TProtocol) error {
...
func (p *BoundCardInfo) ReadField4(iprot thrift.TProtocol) error {
...
func (p *BoundCardInfo) ReadField5(iprot thrift.TProtocol) error {
	_, size, err := iprot.ReadListBegin()
	if err != nil {
		return err
	}
...
func (p *BoundCardInfo) ReadField6(iprot thrift.TProtocol) error {
	_, size, err := iprot.ReadListBegin()
	if err != nil {
		return err
	}
	_field := make([]*CardParamMapping, 0, size)
	values := make([]CardParamMapping, size)
	for i := 0; i < size; i++ {
		_elem := &values[i]
		_elem.InitDefault()
	...
	p.ParamMapping = _field
	return nil
}

func (p *BoundCardInfo) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("BoundCardInfo"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
		if err = p.writeField1(oprot); err != nil {
...
func (p *BoundCardInfo) writeField1(oprot thrift.TProtocol) (err error) {
	if p.IsSetCardID() {
...
func (p *BoundCardInfo) writeField2(oprot thrift.TProtocol) (err error) {
	if p.IsSetCardName() {
		if err = oprot.WriteFieldBegin("card_name", thrift.STRING, 2); err != nil {
			goto WriteFieldBeginError
		}
		if err := oprot.WriteString(*p.CardName); err != nil {
			return err
		}
		if err = oprot.WriteFieldEnd(); err != nil {
			goto WriteFieldEndError
...
func (p *BoundCardInfo) writeField3(oprot thrift.TProtocol) (err error) {
	if p.IsSetCode() {
...
func (p *BoundCardInfo) writeField4(oprot thrift.TProtocol) (err error) {
	if p.IsSetCardPicURL() {
		if err = oprot.WriteFieldBegin("card_pic_url", thrift.STRING, 4); err != nil {
			goto WriteFieldBeginError
		}
		if err := oprot.WriteString(*p.CardPicURL); err != nil {
			return err
		}
		if err = oprot.WriteFieldEnd(); err != nil {
			goto WriteFieldEndError
...
func (p *BoundCardInfo) writeField5(oprot thrift.TProtocol) (err error) {
	if p.IsSetParamList() {
		if err = oprot.WriteFieldBegin("param_list", thrift.LIST, 5); err != nil {
			goto WriteFieldBeginError
		}
...
func (p *BoundCardInfo) writeField6(oprot thrift.TProtocol) (err error) {
	if p.IsSetParamMapping() {
		if err = oprot.WriteFieldBegin("param_mapping", thrift.LIST, 6); err != nil {
			goto WriteFieldBeginError
		}
		if err := oprot.WriteListBegin(thrift.STRUCT, len(p.ParamMapping)); err != nil {
			return err
		}
		for _, v := range p.ParamMapping {
			if err := v.Write(oprot); err != nil {
				return err
			}
		}
...
func (p *BoundCardInfo) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("BoundCardInfo(%+v)", *p)
