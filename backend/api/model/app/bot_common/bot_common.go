...
type MemoryToolConfig struct {
	...
	Mode *MemoryToolMode `thrift:"Mode,1,optional" form:"mode" json:"mode,omitempty"`
}
...
type BotInfo struct {
	...
	BoundCards []*BoundCardInfo `thrift:"BoundCards,38,optional" form:"bound_cards" json:"bound_cards,omitempty"`
}
...
type ExternalKnowledge struct {
	...
	DatasetIds []string `thrift:"dataset_ids,1,optional" form:"dataset_ids" json:"dataset_ids,omitempty"`
	...
	CrossLanguages []string `thrift:"cross_languages,9,optional" form:"cross_languages" json:"cross_languages,omitempty"`
...
type BotInfoForUpdate struct {
	...
	// Bound cards for agent prompt injection
	BoundCards []*BoundCardInfo `thrift:"BoundCards,36,optional" form:"bound_cards" json:"bound_cards,omitempty"`
}
...
type CardParam struct {
	...
	// Nested parameters
	Children []*CardParam `thrift:"children,5,optional" form:"children" json:"children,omitempty"`
}
...
type BoundCardInfo struct {
	...
	// Card parameter list
	ParamList []*CardParam `thrift:"param_list,5,optional" form:"param_list" json:"param_list,omitempty"`
	// Parameter mapping configuration
	ParamMapping []*CardParamMapping `thrift:"param_mapping,6,optional" form:"param_mapping" json:"param_mapping,omitempty"`
}
