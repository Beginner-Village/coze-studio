...
type TabDisplayItems struct {
	...
	ExternalKnowledgeTabStatus *TabStatus `thrift:"external_knowledge_tab_status,21,optional" form:"external_knowledge_tab_status" json:"external_knowledge_tab_status,omitempty" query:"external_knowledge_tab_status"`
}
...
var TabDisplayItems_ExternalKnowledgeTabStatus_DEFAULT TabStatus

func (p *TabDisplayItems) GetExternalKnowledgeTabStatus() (v TabStatus) {
	if !p.IsSetExternalKnowledgeTabStatus() {
		return TabDisplayItems_ExternalKnowledgeTabStatus_DEFAULT
	}
	return *p.ExternalKnowledgeTabStatus
}
...
var fieldIDToName_TabDisplayItems = map[int16]string{
	...
	21: "external_knowledge_tab_status",
}
...
func (p *TabDisplayItems) IsSetExternalKnowledgeTabStatus() bool {
	return p.ExternalKnowledgeTabStatus != nil
}
...
func (p *TabDisplayItems) ReadField21(iprot thrift.TProtocol) error {
	...
	p.ExternalKnowledgeTabStatus = _field
	return nil
}
...
func (p *TabDisplayItems) writeField21(oprot thrift.TProtocol) (err error) {
	if p.IsSetExternalKnowledgeTabStatus() {
		if err = oprot.WriteFieldBegin("external_knowledge_tab_status", thrift.I32, 21); err != nil {
			goto WriteFieldBeginError
		}
		if err := oprot.WriteI32(int32(*p.ExternalKnowledgeTabStatus)); err != nil {
			return err
		}
		if err = oprot.WriteFieldEnd(); err != nil {
			goto WriteFieldEndError
