...
func (p *WorkflowServiceClient) GetCardList(ctx context.Context, request *GetCardListRequest) (r *GetCardListResponse, err error) {
	...
	_args.Request = request
	var _result WorkflowServiceGetCardListResult
	if err = p.Client_().Call(ctx, "GetCardList", &_args, &_result); err != nil {
		return
	}
	return _result.GetSuccess(), nil
}
...
type workflowServiceProcessorGetCardList struct {
	handler WorkflowService
}

func (p *workflowServiceProcessorGetCardList) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	args := WorkflowServiceGetCardListArgs{}
	if err = args.Read(iprot); err != nil {
		iprot.ReadMessageEnd()
		x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
	...
	iprot.ReadMessageEnd()
	var err2 error
	result := WorkflowServiceGetCardListResult{}
	var retval *GetCardListResponse
...
type WorkflowServiceGetCardListArgs struct {
	Request *GetCardListRequest `thrift:"request,1"`
}

func NewWorkflowServiceGetCardListArgs() *WorkflowServiceGetCardListArgs {
	return &WorkflowServiceGetCardListArgs{}
}

func (p *WorkflowServiceGetCardListArgs) InitDefault() {
}

var WorkflowServiceGetCardListArgs_Request_DEFAULT *GetCardListRequest
...
var fieldIDToName_WorkflowServiceGetCardListArgs = map[int16]string{
	1: "request",
}

func (p *WorkflowServiceGetCardListArgs) IsSetRequest() bool {
	return p.Request != nil
}
...
func (p *WorkflowServiceGetCardListArgs) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("WorkflowServiceGetCardListArgs(%+v)", *p)

}

type WorkflowServiceGetCardListResult struct {
	Success *GetCardListResponse `thrift:"success,0,optional"`
}

func NewWorkflowServiceGetCardListResult() *WorkflowServiceGetCardListResult {
	return &WorkflowServiceGetCardListResult{}
}

func (p *WorkflowServiceGetCardListResult) InitDefault() {
}

var WorkflowServiceGetCardListResult_Success_DEFAULT *GetCardListResponse
...
var fieldIDToName_WorkflowServiceGetCardListResult = map[int16]string{
	0: "success",
}

func (p *WorkflowServiceGetCardListResult) IsSetSuccess() bool {
	return p.Success != nil
}
...
func (p *WorkflowServiceGetCardListResult) String() string {
	if p == nil {
		return "<nil>"
	}
