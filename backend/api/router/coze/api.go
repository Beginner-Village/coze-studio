...
import (
	...
	coze "github.com/ynet-dev/ynet-studio/backend/api/handler/coze"
	skillHandler "github.com/ynet-dev/ynet-studio/backend/api/handler/skill"
	workflow "github.com/ynet-dev/ynet-studio/backend/api/handler/workflow"
)
	...
	root := r.Group("/", rootMw()...)
	{
		...
		}
		{
			_superAgent := _api.Group("/super-agent", _draftbotMw()...)
			{
				...
				_runs.POST("/list", coze.SuperAgentListRuns)
				_runs.POST("/reply", coze.SuperAgentReplyRun)
				_runs.POST("/stream", coze.SuperAgentStreamRun)
				_runs.POST("/cancel", coze.SuperAgentCancelRun)
				_config := _superAgent.Group("/config")
				_config.POST("/get", coze.SuperAgentGetToolConfig)
				_config.POST("/update", coze.SuperAgentUpdateToolConfig)
				_runtimeConfig := _superAgent.Group("/runtime-config")
				_runtimeConfig.POST("/get", coze.SuperAgentGetSessionRuntimeConfig)
				_runtimeConfig.POST("/update", coze.SuperAgentUpdateSessionRuntimeConfig)
				_runtimeConfig.POST("/delete", coze.SuperAgentDeleteSessionRuntimeConfig)
				_products := _superAgent.Group("/products")
				_products.POST("/list", coze.SuperAgentListProducts)
				_products.POST("/get", coze.SuperAgentGetProduct)
				_products.POST("/install", coze.SuperAgentInstallProduct)
				_products.POST("/upgrade", coze.SuperAgentUpgradeProduct)
				_products.POST("/uninstall", coze.SuperAgentUninstallProduct)
				_sessions := _superAgent.Group("/sessions")
				_sessions.POST("/create", coze.SuperAgentCreateSession)
				_sessions.POST("/get", coze.SuperAgentGetSession)
				_sessions.POST("/list", coze.SuperAgentListSessions)
				_sessions.POST("/rename", coze.SuperAgentRenameSession)
				_sessions.POST("/delete", coze.SuperAgentDeleteSession)
				_messages := _superAgent.Group("/messages")
				_messages.POST("/list", coze.SuperAgentListMessages)
				_approvals := _superAgent.Group("/approvals")
				_approvals.POST("/list", coze.SuperAgentListApprovals)
				_approvals.POST("/resolve", coze.SuperAgentResolveApproval)
				_harness := _superAgent.Group("/harness")
				_harness.POST("/state", coze.SuperAgentGetHarnessState)
				_harness.POST("/plan", coze.SuperAgentUpdateHarnessPlan)
				_harness.POST("/tool-outputs", coze.SuperAgentListHarnessToolOutputs)
				_harness.POST("/cleanup", coze.SuperAgentCleanupHarnessToolOutputs)
				_harness.POST("/context/clear", coze.SuperAgentClearHarnessContext)
				_harness.POST("/resume", coze.SuperAgentGetHarnessResume)
				_harness.POST("/snapshot", coze.SuperAgentGetHarnessSnapshot)
				_sandbox := _superAgent.Group("/sandbox")
				_sandbox.POST("/exec", coze.SuperAgentExecSandboxCommand)
				_traces := _superAgent.Group("/traces")
				_traces.POST("/get", coze.SuperAgentGetTrace)
				_artifacts := _superAgent.Group("/artifacts")
				_artifacts.POST("/list", coze.SuperAgentListArtifacts)
				_artifacts.POST("/download", coze.SuperAgentDownloadArtifact)
				_artifacts.POST("/delete", coze.SuperAgentDeleteArtifact)
				_artifacts.POST("/move", coze.SuperAgentMoveArtifact)
				...
				_workspace.POST("/write", coze.SuperAgentWriteWorkspaceFile)
				_workspace.POST("/download", coze.SuperAgentDownloadWorkspaceFile)
				_workspace.POST("/delete", coze.SuperAgentDeleteWorkspaceFile)
				_workspace.POST("/move", coze.SuperAgentMoveWorkspaceFile)
				_workspace.POST("/mkdir", coze.SuperAgentCreateWorkspaceDirectory)
				_workspace.POST("/stat", coze.SuperAgentStatWorkspacePath)
				_workspace.POST("/grep", coze.SuperAgentGrepWorkspace)
				_workspace.POST("/glob", coze.SuperAgentGlobWorkspace)
				_workspace.POST("/edit", coze.SuperAgentEditWorkspaceFile)
				_workspace.POST("/patch", coze.SuperAgentApplyWorkspacePatch)
				_skills := _superAgent.Group("/skills")
				_skills.POST("/create", skillHandler.CreateSkill)
				_skills.POST("/validate-package", skillHandler.ValidateSkillPackage)
				_skills.POST("/import", skillHandler.ImportSkillPackage)
				_skills.POST("/import-runtime", skillHandler.ImportRuntimeSkill)
				_skills.POST("/export", skillHandler.ExportSkillPackage)
				_skills.GET("/get", skillHandler.GetSkill)
				_skills.POST("/update", skillHandler.UpdateSkill)
				_skills.POST("/delete", skillHandler.DeleteSkill)
				_skills.POST("/publish", skillHandler.PublishSkill)
				_skills.GET("/list", skillHandler.ListSkills)
				_skills.GET("/assets/list", skillHandler.ListSkillAssets)
				_skills.GET("/assets/get", skillHandler.GetSkillAsset)
				_skills.POST("/assets/upsert", skillHandler.UpsertSkillAsset)
				_skills.POST("/assets/delete", skillHandler.DeleteSkillAsset)
				_marketplace := _superAgent.Group("/marketplace")
				_marketplace.GET("/list", skillHandler.ListMarketplaceSkills)
				_marketplace.GET("/get", skillHandler.GetMarketplaceSkill)
				_marketplace.POST("/install", skillHandler.InstallMarketplaceSkill)
				_marketplace.POST("/products/list", coze.SuperAgentListMarketplaceProducts)
				_marketplace.POST("/products/get", coze.SuperAgentGetMarketplaceProduct)
				_marketplace.POST("/products/install", coze.SuperAgentInstallProduct)
				_agentApp := _superAgent.Group("/agent-app")
				_agentApp.POST("/publish", coze.SuperAgentPublishAgentApp)
				_agentApp.POST("/build-status", coze.SuperAgentAgentAppBuildStatus)
				_agentApp.POST("/recruit", coze.SuperAgentRecruitAgentApp)
			}
		}
		{
		...
		}
		{
			...
			_plugin_api.POST("/update_folder", append(_updatefolderMw(), coze.UpdateFolder)...)
			_plugin_api.POST("/delete_folder", append(_deletefolderMw(), coze.DeleteFolder)...)
		}
		{
		...
		}
		{
			...
			_workflow_api.POST("/agent_test_run", append(_workflowtestrunMw(), coze.WorkFlowAgentTestRun)...)
