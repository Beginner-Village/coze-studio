...
import (
	...
	space_member "github.com/ynet-dev/ynet-studio/backend/api/handler/space_member"
)
	...
	root := r.Group("/", rootMw()...)
	{
		_api := root.Group("/api", _apiMw()...)
		{
			...
			_space.GET("/search-users", append(_searchusersMw(), space_member.SearchUsers)...)
			{
				...
				__7bspace_id_7d.GET("/permission", append(_checkmemberpermissionMw(), space_member.CheckMemberPermission)...)
			}
		}
	}
}
