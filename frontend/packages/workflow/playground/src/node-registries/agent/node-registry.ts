...
export const AGENT_NODE_REGISTRY: WorkflowNodeRegistry<NodeTestMeta> = {
  type: StandardNodeType.Agent,
  meta: {
    nodeDTOType: StandardNodeType.Agent,
    size: { width: 360, height: 150 },
    nodeMetaPath: DEFAULT_NODE_META_PATH,
    outputsPath: DEFAULT_OUTPUTS_PATH,
    inputParametersPath: DYNAMIC_INPUTS_PATH,
    test,
  },
