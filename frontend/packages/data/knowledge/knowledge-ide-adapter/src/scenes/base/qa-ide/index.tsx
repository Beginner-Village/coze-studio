...
export interface BaseKnowledgeQAIDEProps extends BaseKnowledgeIDEProps {
  contentProps?: Partial<TableKnowledgeWorkspaceProps>;
}

// QA IDE: reuses Table IDE layout since Q/A pairs are stored in table-like structure
// but uses QA-specific menu with QA_DOC unit type
...
export const BaseKnowledgeQAIDE = (props: BaseKnowledgeQAIDEProps) => (
