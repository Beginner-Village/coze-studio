...
export const GetCardList = /*#__PURE__*/createAPI<GetCardListRequest, GetCardListResponse>({
  "url": "/api/workflow_api/card_list",
  "method": "POST",
  "name": "GetCardList",
  "reqType": "GetCardListRequest",
  "reqMapping": {
    "body": ["apiEndpoint", "searchKeyword", "filters"]
  },
  "resType": "GetCardListResponse",
  "schemaRoot": "api://schemas/idl_workflow_workflow",
  "service": "workflow"
});
export const GetCardDetail = /*#__PURE__*/createAPI<GetCardDetailRequest, GetCardDetailResponse>({
  "url": "/api/workflow_api/card_detail",
  "method": "POST",
  "name": "GetCardDetail",
  "reqType": "GetCardDetailRequest",
  "reqMapping": {
    "body": ["apiEndpoint", "cardId"]
  },
  "resType": "GetCardDetailResponse",
  "schemaRoot": "api://schemas/idl_workflow_workflow",
  "service": "workflow"
});